...
{
    internal class AssignDistributedMomentXZPlaneToFrame : AssignCommand
    {
        private IFrameLoadFactory factory;

        public AssignDistributedMomentXZPlaneToFrame(IDatabase dbctx, IFrameLoadFactory factory) : base(dbctx)
        {
        ...
        public override string Execute(IList<string> parameters)
        {
            ...
            ILoad frameLoad = this.factory.CreateDistributedMomentXZPlane(loadCase, frameElement.ElementLength, gCoefficient,
