...
{
    internal class AssignConcentratedLoadGlobalYDirection : AssignCommand
    {
        private IFrameLoadFactory factory;

        public AssignConcentratedLoadGlobalYDirection(IDatabase dbctx, IFrameLoadFactory factory) : base(dbctx)
        {
