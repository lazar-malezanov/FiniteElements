...
{
    internal class AssignConcentratedMomentAroundGlobalXDirection : AssignCommand
    {
        private IFrameLoadFactory factory;

        public AssignConcentratedMomentAroundGlobalXDirection(IDatabase dbctx, IFrameLoadFactory factory) : base(dbctx)
        {
        ...
        public override string Execute(IList<string> parameters)
        {
            ...
            {
                throw new ArgumentException("Failed to parse AssignConcentratedMomentAroundGlobalXDirection command parameters.");
            }
            ...
            return $"Concentrated frame moment around global X direction with intensity {loadValue} and Load Case Numeber {loadCaseNumber} has been assigned to element with ID {frameElement.Number}.";
        }
    }
}
