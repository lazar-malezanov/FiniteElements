...
{
    internal class AssignDistributedMomentAroundGlobalYDirection : AssignCommand
    {
        private IFrameLoadFactory factory;

        public AssignDistributedMomentAroundGlobalYDirection(IDatabase dbctx, IFrameLoadFactory factory) : base(dbctx)
        {
