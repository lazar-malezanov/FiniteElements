...
{
    internal class AssignConcentratedShearLoadXYPlaneToFrame : AssignCommand
    {
        private IFrameLoadFactory factory;

        public AssignConcentratedShearLoadXYPlaneToFrame(IDatabase dbctx, IFrameLoadFactory factory) : base(dbctx)
        {
        ...
        public override string Execute(IList<string> parameters)
        {
            ...
            ILoad frameLoad = this.factory.CreateConcentratedShearLoadXYPlane(loadCase, frameElement.ElementLength, gCoefficient,
