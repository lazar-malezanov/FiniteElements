...
{
    internal class ForceYDirection : NodalForces
    {
        private readonly string type = "Nodal Force in global Y direction";
        ...
        {
            return Vector<double>.Build.SparseOfArray(new double[] { 0.0, this.loadValue, 0.0, 0.0, 0.0, 0.0 });
        }
