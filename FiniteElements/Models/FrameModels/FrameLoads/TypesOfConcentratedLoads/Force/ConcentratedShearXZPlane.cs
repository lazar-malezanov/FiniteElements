...
{
    internal class ConcentratedShearXZPlane : ConcentratedLoads
    {
        private readonly string type = "Concentrated Shear Force XZ Plane";

        public ConcentratedShearXZPlane(ILoadCase loadCase, double elementLength, double gCoefficient,
