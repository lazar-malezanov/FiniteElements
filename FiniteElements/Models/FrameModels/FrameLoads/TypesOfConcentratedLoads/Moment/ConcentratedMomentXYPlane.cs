...
{
    internal class ConcentratedMomentXYPlane : ConcentratedLoads
    {
        private readonly string type = "Concentrated Moment XY Plane (around element's Z axis)";

        public ConcentratedMomentXYPlane(ILoadCase loadCase, double elementLength, double gCoefficient,
