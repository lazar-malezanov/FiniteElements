...
{
    internal class DistributedShearXYPlane : DistributedLoads
    {
        private readonly string type = "Distributed Shear Force in XY Plane";

        public DistributedShearXYPlane(ILoadCase loadCase, double elementLength, double gCoefficient, double loadAtStart, double loadAtEnd, 
